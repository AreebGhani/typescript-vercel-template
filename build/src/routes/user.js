...
import { isAuthenticated, isActive, requiredRoles, multerUpload, validateCredentials, } from '../middlewares/index.js';
 ...
 */
router.put(ApiPath.User.Update, isAuthenticated, isActive, multerUpload.single('image'), validateCredentials({ type: 'update' }), put.Update);
/**
 * @openapi
 ...
 *                   example: "an unknown error occurred"
 */
router.put(ApiPath.User.ChangeStatus, isAuthenticated, isActive, requiredRoles('admin'), put.ChangeStatus);
/**
 * @openapi
 * /user/all:
 *   get:
