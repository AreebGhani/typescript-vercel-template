...
import { ErrorHandler, InternalServerError, uploadMedia, s3Client } from '../../utils/index.js';
const allowedPurposes = ['profile'];
...
export const GenerateSignedUrl = catchAsyncErrors(async (req, res, next) => {
