 ...
 */
export const combineDate = (month, year) => {
 ...
 */
export const getNumberOfDays = (from, to) => differenceInCalendarDays(new Date(to), new Date(from)) + 1;
/**
 ...
 */
export const calculateHoursDifference = (date) => {
