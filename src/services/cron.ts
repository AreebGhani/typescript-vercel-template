...
import { InternalServerError, listAllFiles, deleteFile } from '@/utils';
import db from '@/mongodb';

const scheduledDeleteUnusedFilesTask = async (now: Date | 'manual' | 'init'): Promise<void> => {
